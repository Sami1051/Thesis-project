...
def multi_tfrecord_loader(
    ...
    index_pattern: typing.Union[list[str], None],
    #splits: typing.Dict[str, float],
    splits: typing.Dict[int,float],
    description: typing.Union[typing.List[str], typing.Dict[str, str], None] = None,
    sequence_description: typing.Union[typing.List[str], typing.Dict[str, str], None] = None,
    compression_type: typing.Optional[str] = None,
    infinite: bool = True,
    ...
    loaders = [
        functools.partial(
            ...
            data_path=data_pattern[split],
            #index_path=index_pattern.format(split) if index_pattern is not None else None,
            index_path=index_pattern[split] if index_pattern is not None else None,
            description=description,
    ...
    #for split in splits.keys():
    #    print ('index_path:', index_pattern.format(split))
